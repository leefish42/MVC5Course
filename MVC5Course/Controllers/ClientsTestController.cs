...
{
    public class ClientsTestController : Controller
    {
        ...
        {
            var client = db.Client.Include(c => c.Occupation).OrderBy(p => p.ClientId).ToPagedList(page, 10);
            return View(client);
        }

        // GET: ClientsTest/Details/5
